...
i spend a good couple hours trying not to just have a util that mapped entities to arrays for serialization but would have had to re-do most of my code to implement serializer(which i did not understand off the bat anyway) i felt very spoiled by java's " implements Serializable" ha!
...
overrall, I attempted something new and challenged myself. I wouldnt say i rose to meet the challenge especially well, but i learnt many things and enjoyed the process.
